...
class AdminNewContracts extends StatelessWidget {
  const AdminNewContracts({Key? key}) : super(key: key);

  Widget build(BuildContext context) {
    return Scaffold(
      body: PaginateFirestore(
        shrinkWrap: true,
        onEmpty: const Center(child: Text("You have no new Contracts Yet")),
        ...
        query: contractsRef
            .where('status', isEqualTo: 'New Contract')
