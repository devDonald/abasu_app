...
class AdminCompletedContracts extends StatelessWidget {
  const AdminCompletedContracts({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PaginateFirestore(
        shrinkWrap: true,
        onEmpty:
            const Center(child: Text("You have no Completed Contracts Yet")),
