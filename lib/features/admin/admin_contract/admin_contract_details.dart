...
class AdminContractDetails extends StatefulWidget {
  ...
  @override
  State<AdminContractDetails> createState() => _AdminContractDetailsState();
}

class _AdminContractDetailsState extends State<AdminContractDetails> {
  Size? screenSize;
  @override
                      ...
                      confirm: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (widget.images != null) {
                              ContractDB.deleteFile(widget.model!.imagesNames!);
                            }
                            successToastMessage(
  ...
  void _adminRespond(BuildContext ctx) {
