...
class AdminOngoingRequests extends StatelessWidget {
  const AdminOngoingRequests({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PaginateFirestore(
        shrinkWrap: true,
        onEmpty: const Center(child: Text("No Ongoing Requests yet")),
        ...
        query: requestRef
            .where('status', isNotEqualTo: 'New Request')
